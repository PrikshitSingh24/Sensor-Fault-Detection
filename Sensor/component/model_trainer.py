...
from Sensor.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact,ModelTrainerArtifact
from Sensor.entity.config_entity import DataValidationConfig,ModelTrainerConfig,DataTransformationConfig
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
            try:
                ...
                if diff>self.model_trainer_config.overfitting_underfitting_threshold:
                    raise Exception("model is not goot try to do more experimentation.")
